...
export const fetchEventQuickFilters = playhubApi.fetchEventQuickFilters;
...
export const autocompletePlaces = playhubApi.autocompletePlaces;
export const searchCardsQuick = playhubApi.searchCardsQuick;
export const searchCardsWithFilters = playhubApi.searchCardsWithFilters;
export const fetchCardById = playhubApi.fetchCardById;
